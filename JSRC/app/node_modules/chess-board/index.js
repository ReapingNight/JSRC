...
function move(board)
{
    return function(posOld, posNew){
        ...
        if(piece !== null)
        {
            ...
            let other = find(board, "position", posNew);
            ...
            if(other)
            {
                ...
                {
                    other.position = "lostPieces";
                    temp.push({color: other.color, type: other.type, position: "lostPieces", posOld: parseInt(other.position)})
                }
            }
