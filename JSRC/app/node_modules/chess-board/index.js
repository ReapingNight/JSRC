...
{
    let piece = find("position", posOld);
    if(piece !== null)
    {
        piece.position = posNew;
        return {color: piece.color, type: piece.type, position: piece.position, posOld: posOld};
    }
...
module.exports = {board: board, move: move};